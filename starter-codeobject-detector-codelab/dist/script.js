...
// Import the required package.
import { ObjectDetector, FilesetResolver } from "https://cdn.skypack.dev/@mediapipe/tasks-vision@latest";
...
async function initializeObjectDetector() {
    const visionFilesetResolver = await FilesetResolver.forVisionTasks("https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.1/wasm");
